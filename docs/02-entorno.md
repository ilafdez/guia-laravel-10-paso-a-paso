...
!!! tip "Bonus: Extensiones de VS Code para desarrollar en Laravel"
    Puedes instalar algunas extensiones de VS Code para facilitar el desarrollo con Laravel. En el siguiente [enlace](https://devdojo.com/bobbyiliev/8-awesome-vs-code-extensions-for-laravel-developers) tienes una recopilación de las más recomendadas.